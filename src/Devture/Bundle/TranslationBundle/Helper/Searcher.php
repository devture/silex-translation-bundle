...
class Searcher {
	...
	private function isSourceResourceMatching(SourceResource $sourceResource, SearchRequest $searchRequest) {
	...
	private function isResourceMatching(ResourceInterface $resource, SearchRequest $searchRequest) {
	...
	private function isTranslationStringMatching(TranslationString $translationString, SearchRequest $searchRequest) {
